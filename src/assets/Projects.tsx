...
const projects = [
    ...
    // Add potentially failing image for testing onError
    // {
    //     id: 4,
    //     title: 'Broken Image Test',
    //     imageUrl: 'https://invalid-url-that-will-fail.xyz/image.jpg',
    //     description: 'This image should fail to load.',
    //     githubUrl: '#',
    // },
];
                            ...
                            <div key={project.id} className="col">
                                <a href={project.githubUrl} target="_blank" rel="noopener noreferrer" className="card project-card h-100 shadow-sm">
                                    <img
                                        ...
                                        // --- FIX IS HERE ---
                                        onError={(e) => {
                                            // Assert that the target is an HTMLImageElement
                                            const target = e.target as HTMLImageElement;
                                            // Set onerror to null BEFORE changing src to prevent potential infinite loops
                                            // if the fallback image also fails
                                            target.onerror = null;
                                            target.src = "https://placehold.co/600x400/CCCCCC/31343C?text=Image+Not+Found";
                                        }}
                                        // --- END FIX ---
                                    />
